...
<section class="gradient-form h-full bg-neutral-200 dark:bg-neutral-700">
  <div class=" register container h-full p-10">
    <div
  ...
  methods: {
    register() {
      ...
      if (this.first_name != "" && this.last_name != "") {
        axios({
          url: "http://localhost/CinemaHall/api/clients/register",
          method: "post",
          data: formdata,
        }).then((res) => {
          // after sucess
          ...
          Swal.fire({
            ...
            `${res.data.Ref}` +
              " Click " +
              '<a href="/login" class="text-blue-500 underline">here</a>' + " to login",
          });
        });
      } else {
        Swal.fire({
